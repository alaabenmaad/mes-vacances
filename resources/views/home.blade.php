    ...
    <div class="container mx-auto px-8">
      <div class="w-full flex flex-col md:flex-row py-6">
        <div class="flex-1 mb-6 text-black">
          ...
          <div>
            <p>Created By</p>
            <a href="https://alaa-benmaad.me/" class="no-underline hover:underline text-gray-800 hover:text-pink-500">Alaa BEN MAAD</a>
            <img src="{{ asset('img/logo rounded.png') }}" alt="" style="height:80px ;" />
          </div>
        </div>
        <div class="flex-1">
